...
const menu = [
  ...
  { href: '/admin/studio', label: '工作室', icon: 'M11 4H6a2 2 0 00-2 2v12a2 2 0 002 2h12a2 2 0 002-2v-5m-1.4-9.4a2 2 0 112.8 2.8L12 17l-4 1 1-4 9.4-9.4z' },
  { href: '/admin/media', label: '媒體庫', icon: 'M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z' },
