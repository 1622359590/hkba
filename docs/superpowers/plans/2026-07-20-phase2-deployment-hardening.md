...
- [x] **Step 1: Write the failing password-resolution tests**
...
- [x] **Step 3: Implement password resolution and remove password logging**
...
- [x] **Step 5: Commit the credential hardening**
...
- [x] **Step 1: Add a failing WAL-aware online backup test**
...
- [x] **Step 3: Implement the online backup path**
...
- [x] **Step 4: Verify backup behavior**
...
- [x] **Step 5: Commit the backup change**
...
- [x] **Step 3: Implement the smoke probe**
...
- [x] **Step 6: Verify workflow and documentation**
...
- [x] **Step 7: Commit deployment orchestration**
...
- [x] **Step 2: Run deployment helper tests**
...
- [x] **Step 4: Review the final diff for data-loss risks**
...
- [x] **Step 5: Mark the plan complete and commit verification metadata**
...
Completed on 2026-07-20 from `codex/phase2-hardening`:

- Backend: `164` tests passed, `0` failed.
- Deployment smoke probe: `5` tests passed, `0` failed.
- Bundled deployment secret parser: all shell tests passed.
- Frontend: Next.js production build and TypeScript checks passed.
- HTTP smoke E2E: all six flows passed (login, page creation, draft, publish, public visibility, redirects).
- Workflow YAML parsed successfully and shell helper syntax passed.
- Branch diff passed whitespace, runtime-data preservation, and secret-exposure review.
